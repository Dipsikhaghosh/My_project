    <?php include "controler/controlerview_user.php"; ?>
<!DOCTYPE html>
<html>
    ...
    <section class="logins py-5">
        <div class="container py-xl-5 py-lg-3">
            <div class="title-section mb-md-5 mb-4">
                <h6 class="w3ls-title-sub">Editing</h6>
                <h3 class="w3ls-title text-uppercase text-dark font-weight-bold">Doctor's Registration Form</h3>
            </div>
            <div class="login px-sm-4 mx-auto mw-100 login-wrapper">
                <form class="form-horizontal" method="post" action="controler/controlermodify_user.php">
