		...
		<div class="jumbotron">
			<div class="container">
				<div class="banner-info_agile_w3ls text-center mx-auto">
					<h1>Docs-Inn</h1> 
  					<p>Doctors available all time</p>
					<h3 class="text-wh font-weight-bold">Providing extensive family Health care</h3>
					<a href="about.php" class="btn button-w3ls mt-5">Read More</a> 
				</div>
			</div>
		</div>
	</div>
...
<!-- 	</div> -->
	...
	<!-- services -->
	<div>
<h3 class="w3ls-title text-uppercase text-bl font-weight-bold">SERVICES THAT WE OFFER</h3>
			</div>
		...
		<div class="container pb-xl-5 pb-lg-3">
			<div class="row mt-30">
				<div class="col-lg-4 mt-lg-4 mb-lg-0 mb-4">
					...
					<h3 class="w3ls-title text-bl font-weight-bold">Meet Our Doctors. <br>Our team of Doctors always ready to
						help
						you.</h3>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="box16">
						<img src="images/0.jpg" alt="" class="img-fluid">
						<div class="box-content">
				...
				<div class="col-lg-6">
					<div class="d-flex services-box">
						...
						<div class="service-content ml-4">
							...
							<a href="about.php" class="butn-w3pvt font-weight-bold btn text-wh text-uppercase">Read More</a>
						</div>
						<!-- .Service-content ends here -->
					</div>
					<div class="d-flex services-box mt-5">
			...
			<div class="row"> -->
						...
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="single.php">Dictum porta auris</a>
								</h5>
							...
							<a href="single.php" class="blog-btn btn">Read more</a>
						</div>
					</div>
				</div> -->
				<!-- //blog grid -->
				...
				<!-- 	<div class="card border-0 med-blog">
						<div class="card-body border border-bottom-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="single.php">Sed do eiusmod</a>
								</h5>
								<div class="blog_w3icon">
									<span>
				...
				<!-- <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="single.php">Tempor inci didunt</a>
								</h5>
								<div class="blog_w3icon">
									<span>
				...
				<!-- <div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="single.php">Labore et dolore</a>
								</h5>
								<div class="blog_w3icon">
									<span>
				...
				<!-- <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-body border border-bottom-0 pb-5">
							<div class="mb-3">
								<h5 class="blog-title card-title font-weight-bold m-0">
									<a href="single.php">Ut enim ad minim</a>
								</h5>
								<div class="blog_w3icon">
									<span>
	...
	<!-- //blog -->
	<div>
<h3 class="w3ls-title text-uppercase text-bl font-weight-bold">Why  you Choose Us</h3>
			</div>
			<div class="row">
				<!-- blog grid -->
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0">
							...
							<a href="single.php" class="btn blog-btn mt-4">Read more</a>
						</div>
					</div>
				</div>
				<!-- //blog grid -->
