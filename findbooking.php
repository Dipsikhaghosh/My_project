...
<?php
	$id=$_GET['did'];
	include("controler/routineview.php");
?>
	<!-- register -->
	<section class="logins py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="login px-sm-4 mx-auto mw-100 login-wrapper">
				<form method="post" id="regfrm" action="findbooking2.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Date[please, enter a valid date]</label>
						<input type="date" class="form-control" name="date" id="date" placeholder="" required="">
					</div>
					<button name ="submit" type="submit" class="btn submit mt-4" id="submitbtn">Register</button>
					<p class="text-center mt-5">
						<a href="#">By clicking Register, I agree to your terms</a>
					</p>					
		</table>
