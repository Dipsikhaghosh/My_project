	...
	<section class="logins py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section mb-md-5 mb-4">
				...
				<h3 class="w3ls-title text-uppercase text-dark font-weight-bold">Patient's Registration Form</h3>
			</div>
			<div class="login px-sm-4 mx-auto mw-100 login-wrapper">
				<form method="post" id="regfrm" action="controler/dataadd.php" enctype="multipart/form-data"><input type="hidden" name="tab" value="user">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="phno" id="phno" placeholder="phone number" minlength="10" maxlength="10" required>
					</div>
					<div class="form-group">
						<label class="mb-2">Password</label>
						<input type="password" class="form-control" name="password" id="password1" minlength="5" placeholder="password" required>
					</div>
					<!--
					...
					<div class="form-group mb-4">
						...
						<input type="file" class="form-control" name="image" id="file" placeholder="profile picture" required>
					</div>
