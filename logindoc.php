	...
	<section class="logins py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section mb-md-5 mb-4">
				...
				<h3 class="w3ls-title text-uppercase text-dark font-weight-bold">Doctor Login Now</h3>
			</div>
			<div class="login px-sm-4 mx-auto mw-100 login-wrapper">
				<form class="login-wrapper" action="controler/login.php" method="post">
					<input type="hidden" name="tab" value="doctor">
					<input type="hidden" name="src" value="../logindoc.php">
					<input type="hidden" name="dest" value="../doc.php">
