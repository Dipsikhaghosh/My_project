	...
	<section class="logins py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="login px-sm-4 mx-auto mw-100 login-wrapper">
				<form method="post" id="regfrm" action="controler/updatereport.php" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?php echo $id;?>">
					<div class="form-group">
						<label>Report</label>
						<input type="textarea" class="form-control" name="report" id="date" placeholder="" required="">
					</div>
