...
<head>
	<title>Be Clinic Medical Category Bootstrap Responsive Website Template | Gallery :: W3layouts</title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<div class="gallery py-5" id="gallery">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="gal-pop-style pt-xl-4">
				<div class="row">
					<?php $getDoc = mysqli_query($con,"SELECT * FROM doctor WHERE d_status='0'");
	...
	<div id="gal1" class="popup-effect">
		<div class="popup">
			...
			<h5 class="text-name-pop mt-4">Be Clinic</h5>
