<?php include "controlerview_user.php"; ?>
<!DOCTYPE html5>
<head>
...
<section class="logins py-5">
    ...
    <form class="form-horizontal" method="post" action="controlermodify_user.php">
       ...
       <div class="form-group" >
        ...
        <div class="form-group">
            ...
            <div class="col-xs-3">
                <input type="text" class="form-control" name="district" value="<?php echo $record['u_dist']; ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group mb-4">
                        ...
                        <select name="blood class="form-control" value="<?php echo $record['u_blood']; ?>" >
