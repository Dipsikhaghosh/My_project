        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home.php"><i class="fa fa-dashboard"></i>User Dashboard</a>
                    </li>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input name="newus"  class="form-control" placeholder="Enter User name" id="name" name="name">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>New Password</label>
                                            <input name="newps"  class="form-control" placeholder="Enter Password" id="password" name="password">
											</div>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                           ...
                                           <input type="submit" name="in" value="Add" class="btn btn-primary" id="submitbtn">
										  </form>
